...
import api from 'api';
import { IUpdateThemeReviewProps } from 'api/themeReviews';
...
const ThemeReview: React.FC<IProps> = ({ id, review }) => {
  ...
  const mutation = useMutation(
    (data: IUpdateThemeReviewProps) => api.themeReviews.updateReview(data),
    {
      onSuccess: () => {
        alert('리뷰가 작성되었습니다.');
        setSubmitting(false);
